...
describe("Testing for days of the week", function() {
    ...
    it("it should test for both values Thurday when a date on Thurday is selected", function() {
        daysInstance.set_date_value_1("05/4/2023")
        
        assert.equal("Thurday", daysInstance.get_day_class(daysInstance.get_date_value_1()))

        daysInstance.set_date_value_2("05/4/2023")
        
        assert.equal("Thurday", daysInstance.get_day_class(daysInstance.get_date_value_2()))
    })
